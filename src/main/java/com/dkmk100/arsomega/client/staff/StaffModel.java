...
public class StaffModel extends AnimatedGeoModel implements IStaffModel {
    ...
    public ResourceLocation getModel(ItemStack stack, ModularStaff.StaffPart part) {
    ...
    public ResourceLocation getTexture(ItemStack stack, ModularStaff.StaffPart part) {
        return getOnStaffOrDefault(
    ...
    public ResourceLocation getAnimation(ItemStack stack, ModularStaff.StaffPart part) {
        return getOnStaffOrDefault(
    ...
    public Color getColor(ItemStack stack, ModularStaff.StaffPart part){
        return getOnStaffOrDefault(
